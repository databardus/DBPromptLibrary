# DBPromptLibrary
An educational repo for those looking to use generative AI that uses a database as context.
It is intended to be a learning tool to help you understand how to build your own prompts,
and certain approaches you can use to make prompts organized and reusable.

By no means is this repo intended to be 'plug and play' for production use cases. Each LLM used
with these prompts may generate different results, and you should always validate the output of any LLM
